					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							...
							<div class="shop-body">
								...
								<a href="#" class="cta-btn">Tawar Sekarang<i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</div>
					<!-- /shop -->
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									...
									?>
									<li><a data-toggle="tab" href="#tab1"><?php echo $kategolimnew->nama_jenis_barang; ?></a></li>
									<?php
									}
									?>
								</ul>
								...
								<div class="col-md-12">
									<div class="section-title">
										<div class="section-nav">
											<ul class="section-tab-nav tab-nav">
												<br>
												<li class="active"><a data-toggle="tab" href="#tab2">Selengkapnya</a></li>
											</ul>
										</div>
									</div>
								</div>
