        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                  <ul id="sidebarnav">
                      <li class="dropdown-btn"> <a class="waves-effect waves-dark" href="<?php echo base_url('Admin'); ?>" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Top-Up User</span></a></li>
